...
local dark_colors = {
    ...
    nord7_gui = named_colors.yellow, -- nord7 in palette
    nord8_gui = named_colors.yellow, -- nord8 in palette
    nord9_gui = named_colors.yellow, -- nord9 in palette
    nord10_gui = named_colors.yellow, -- nord10 in palette
