...
local dark_colors = {
    ...
    nord11_gui = named_colors.yellow, -- nord11 in palette
    nord12_gui = named_colors.yellow, -- nord12 in palette
    nord13_gui = named_colors.yellow, -- nord13 in palette
    nord14_gui = named_colors.yellow, -- nord14 in palette
    nord15_gui = named_colors.yellow, -- nord15 in palette
    none = "NONE"
}
